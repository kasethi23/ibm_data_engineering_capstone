...
# Connect to MySQL
connection = mysql.connector.connect(user='root', password='ODAyMS1zZXRoaWty',host='127.0.0.1',database='sales')
cursor_msql=connection.cursor()
# Connect to DB2 or PostgreSql
dsn_hostname = '127.0.0.1'
dsn_user='postgres'        # e.g. "abc12345"
dsn_pwd ='NDE2MS1zZXRoaWty'      # e.g. "7dBZ3wWt9XN6$o0J"
